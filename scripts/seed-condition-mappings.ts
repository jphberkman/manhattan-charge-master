...
const MAPPINGS: [string, string, string, string, number][] = [
  ...
  ["ankle fracture", "S82.891A", "27792", "Ankle fracture repair (ORIF)", 100],
  ["broken ankle", "S82.891A", "27792", "Ankle fracture repair (ORIF)", 100],
  ...
  ["hysterectomy", "", "58150", "Total abdominal hysterectomy", 100],
  ["fibroids", "D25.9", "58150", "Total abdominal hysterectomy", 80],
  ...
  // Common outpatient
  ["wisdom teeth", "", "D7240", "Wisdom tooth extraction (impacted)", 100],
