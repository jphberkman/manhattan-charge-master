...
First three attachments are inventoried in `docs/restoration/07-received-file-inventory.md`. None were ingested. Founder confirmed `chargemaster.xlsx` hospital is **unknown** — quarantined, not ingested.
